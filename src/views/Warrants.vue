<template>
  <div id="internal-notes">
    <content-body
      ...
      buttonText="Tambah Surat Perintah"
      :headers="headers"
...
export default {
  ...
  data: () => ({
    ...
    editForms: {},
    forms: [
      { label: 'File Surat Perintah', type: 'file', value: 'file' },
  ...
  computed: {
    warrants() {
      return this.$store.state.warrants.collection
    }
  },
  methods: {
    createWarrants() {
      this.$store.dispatch('warrants/post', this.addForms)
      this.dialogAdd = false
      this.addForms = {}
    },
    editWarrants() {
      this.$store.dispatch('warrants/put', this.editForms)
      this.dialogEdit = false
      this.editForms = {}
    },
    removeWarrants() {
      this.$store.dispatch('warrants/remove', this.editForms)
